...
# =============================================================================
# https://github.com/zhutmost/neuralzip/blob/master/apputil/progressbar.py
# https://github.com/PyTorchLightning/pytorch-lightning/issues/4876
# =============================================================================


class ProgressBar(pl.callbacks.ProgressBarBase):
    def __init__(self, logger, refresh_rate: int = 1):
        super().__init__()
        self._logger = logger
    ...
    def on_train_batch_end(self, trainer, pl_module, outputs, batch, batch_idx, dataloader_idx):
        ...
        if self.is_enabled and self.train_batch_idx % self.refresh_rate == 0:
            ...
            msg += self._serialize_metrics(trainer.progress_bar_dict,
                                           filter_fn=lambda x: not x.startswith('val_') and not x.startswith('test_') and not x.startswith('train_'))
