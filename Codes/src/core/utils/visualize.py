...
def get_color_pallete(npimg, dataset='idine'):
    """Visualize image.
...
# mfn1 = _generatepallete(9)
# soda1 = _generatepallete(21)
generic = _generatepallete(1000)
