...
class SCUTSEGDataset(SegmentationDataset):
    ...
    def __init__(self, root='./',
        ...
        super(SCUTSEGDataset, self).__init__(root, split, mode, base_size, crop_size, logger)
        ...
        self.images, self.mask_paths, self.edge_paths = _get_scutseg_pairs(self.root, self.split, logger)
